...
Culture and society spring from Empathy.\footnote{See the ``Why Are We So
Groupish?'' chapter of The Righteous Mind\cite{haidt2013righteous}} Without
Empathy the deep understanding and trust so necessary for collective action
cannot exist. It is Empathy that spurs us to value the needs of others and
consider how our actions might impact them.
